...
const flatten = (code) => code
    ...
    .replace(/\.\.\/src\/(bench|brain-doctor|agent-presence|agent-rules|capture-gap|finding-routing|mcp-presence|mcp-supervisor|mcp-auto-update|presence-relay|semantic-memory|runtime-inspector|project-graph|git-capture-install|remote-client)\.mjs/g, './$1.mjs')
